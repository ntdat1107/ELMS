...
import learnersidebar from "../../img/LearnerSideBar.png"
...
function Number() {    
    return (
        <div id="number">
            ...
            <NumofUComponent linkName="/admin/learner" idName="numoflearner" imgid="learnericon" number="50192" srcImg={learnersidebar} altName="Learnertor Image" name="Learner" h="40" w="40"/>        
