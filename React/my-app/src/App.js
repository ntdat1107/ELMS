...
import InforCourse from "./Components/Admin/InforCourse";
        ...
        <div className="App">
            <Router>
                <Switch>
                    ...
                    <Route
                        exact
                        path="/ins/managecourse/:fastName/manage_my_learners"
                        component={TableOfLearner}
                    ></Route>
                    <Route
                        exact
                        path="/ins/managecourse/:fastName/addlesson"
                    ...
                    <Route
                        exact
                        path="/learner/mycourses/search/:keyword"
                        component={LnMyCourses}
                    ></Route>
                    ...
                    <Route
                        exact
                        path="/admin/managecourse/:fastName"
